...
def index (request):
    if request.method == "POST":
        ...
        if form.is_valid:
            ...
            return render(request,"app/index.html",{"todo_list":todo_list}) 
    else:
        todo_list = Todos.objects.all()
        return render(request,"app/index.html",{"todo_list":todo_list})
...
def create (request):
    if request.method == "POST":
        ...
        if form.is_valid:
            form.save()
            todo_list = Todos.objects.all()
            return render(request,"app/create.html",{"todo_list":todo_list}) 
    else:
        todo_list = Todos.objects.all()
        return render(request,"app/create.html",{"todo_list":todo_list})
...
def update (request,Todos_id):
    if request.method == "POST":
        ...
        todo_list = Todos.objects.all()
        return render(request,"app/update.html",{"todo_list":todo_list})     